...
public class CarregadorDados {
    ...
    public static void carregar() {
        ...
        rp.adicionar(new Paciente(70.5f, 25, 1.75f, "12345678901", objetivo1, nr.buscar("12345"), "Ana", "ana@example.com", false));
        rp.adicionar(new Paciente(80.0f, 30, 1.80f, "23456789012", objetivo2, nr.buscar("67890"), "Bruno", "bruno@example.com", true));
        rp.adicionar(new Paciente(65.0f, 22, 1.65f, "34567890123", objetivo3, nr.buscar("11223"), "Carlos", "carlos@example.com", true));
        rp.adicionar(new Paciente(55.0f, 28, 1.60f, "45678901234", objetivo1, nr.buscar("12345"), "Diana", "diana@example.com", false));
        rp.adicionar(new Paciente(75.0f, 35, 1.70f, "56789012345", objetivo2, nr.buscar("12345"), "Eduardo", "eduardo@example.com", true));
        rp.adicionar(new Paciente(90.0f, 40, 1.85f, "67890123456", objetivo3, nr.buscar("67890"), "Fernanda", "fernanda@example.com", false));
        rp.adicionar(new Paciente(60.0f, 20, 1.68f, "78901234567", objetivo1, nr.buscar("12345"), "Gustavo", "gustavo@example.com", true));
        rp.adicionar(new Paciente(85.0f, 45, 1.82f, "89012345678", objetivo2, nr.buscar("67890"), "Helena", "helena@example.com", false));
        rp.adicionar(new Paciente(50.0f, 27, 1.55f, "90123456789", objetivo3, nr.buscar("67890"), "Igor", "igor@example.com", true));
        rp.adicionar(new Paciente(68.0f, 33, 1.72f, "01234567890", objetivo1, nr.buscar("11223"), "Julia", "julia@example.com", false));
        rp.adicionar(new Paciente(78.0f, 29, 1.77f, "09876543210", objetivo2, nr.buscar("12345"), "Lucas", "lucas@example.com", true));
